...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', name: string, avatarURL: string, bio: string } | null, challenge?: { __typename?: 'Challenge', url: string } | null } | null };
